    ...
    <div className="">
      <div className="min-h-screen flex flex-col bg-offWhite text-hotPink">
        ...
        <main className="flex-grow">
          ...
          <section 
            id="whatif"
            className="h-full flex items-center justify-center bg-thistle text-slate-700 leading-none pt-30"
          >
            <div className="text-center">
              <h2 className="text-6xl font-bold mb-25">
                What if...
              </h2>
              <div className="grid grid-rows-3 lg:grid-cols-2 xl:grid-cols-3 md:gap-10 mb-30 md:mb-20 xl:-mb-40">
                    {/* Row 1 */}
                    <div className="p-8 border bg-gray-100 h-auto w-auto md:h-90 md:w-110 text-left">
                    ...
                    <div className="p-8 border bg-gray-100 h-auto w-auto md:h-90 md:w-110 text-left">
                        <h6 className="text-xl font-bold">...there were no free accounts?</h6>
          ...
          <section 
            id="process"
            className="min-h-screen flex justify-center py-16"
          >
            <div className="max-w-4xl text-center">
              ...
              <div className="grid md:grid-cols-1 gap-6">
                ...
                <div className="p-6 rounded-lg shadow-md text-hotPink md:flex md:flex-row gap-10">
