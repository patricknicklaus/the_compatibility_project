        ...
        <main className="flex-grow">
          ...
          <section className="min-h-screen flex items-center justify-center text-center bg-offWhite">
            <div>
              ...
              <h4 className="md:text-3xl">a completely different kind of dating app</h4>
            ...
            <div className="max-w-4xl text-center">
              ...
              <div className="grid md:grid-cols-1 gap-2 md:gap-3">
                ...
                <div className="p-6 shadow-md text-hotPink md:flex md:flex-row gap-10 bg-[rgba(255,255,255,0.9)]">
                    <h3 className="text-4xl font-semibold self-center">Step 1</h3>
                ...
                <div className="p-6 shadow-md text-hotPink md:flex md:flex-row gap-10 bg-[rgba(255,255,255,0.9)]">
                    <h3 className="text-4xl font-semibold self-center">Step 2</h3>
                    <div className="text-left md:w-90">
                ...
                <div className="p-6 shadow-md text-hotPink md:flex md:flex-row gap-10 bg-[rgba(255,255,255,0.9)]">
                    <h3 className="text-4xl font-semibold self-center">Step 3</h3>
                    <div className="text-left md:w-90">
                ...
                <div className="p-6 shadow-md text-hotPink md:flex md:flex-row gap-10 bg-[rgba(255,255,255,0.9)]">
                    <h3 className="text-4xl font-semibold self-center">Step 4</h3>
                    <div className="text-left md:w-90">
                ...
                <div className="p-6 shadow-md text-hotPink md:flex md:flex-row gap-10 bg-[rgba(255,255,255,0.9)]">
                    <h3 className="text-4xl font-semibold self-center">Step 5</h3>
                    <div className="text-left md:w-90">
                ...
                <div className="p-6 shadow-md text-hotPink md:flex md:flex-row gap-10 bg-[rgba(255,255,255,0.9)]">
                    <h3 className="text-4xl font-semibold self-center">Step 6</h3>
                    <div className="text-left md:w-90">
                ...
                <div className="p-6 shadow-md text-hotPink md:flex md:flex-row gap-10 bg-[rgba(255,255,255,0.9)]">
                    <h3 className="text-4xl font-semibold self-center">Step 7</h3>
                    <div className="text-left md:w-90">
                ...
                <div className="p-6 shadow-md text-hotPink md:flex md:flex-row gap-10 bg-[rgba(255,255,255,0.9)]">
                    <h3 className="text-4xl font-semibold self-center">Step 8</h3>
                    <div className="text-left md:w-90">
                ...
                <div className="p-6 shadow-md text-hotPink md:flex md:flex-row gap-10 bg-[rgba(255,255,255,0.9)]">
                    <h3 className="text-4xl font-semibold self-center">Step 9</h3>
                    <div className="text-left md:w-90">
