  ...
  return (
    <div className="min-h-screen flex flex-col bg-offWhite text-black">
        <main className="flex-grow mt-20 py-10 px-20">
            ...
            <p className="mb-2">For further details, please refer to our <Link className="border-b-2" to={'/legal/terms_and_condition'}>Terms and Conditions</Link>.</p>
            ...
            <p className="mb-2">No verification process is entirely foolproof. Always exercise caution when interacting with new people, whether online or in person. For tips on staying safe, visit our <Link className="border-b-2" to={'/legal/safety_tips'}>Safety Tips</Link>.</p>
            ...
            <p className="mb-2">We thoroughly review all reports of misconduct. When violations of our <Link className="border-b-2" to={'/legal/terms_and_condition'}>Terms and Conditions</Link> are confirmed, we take action proportionate to the severity of the offense. Penalties range from warnings to permanent bans, with serious offenses—such as violence, threats, or sexual misconduct—resulting in immediate bans.</p>
            ...
            <p className="mb-2">Outside of these circumstances, as outlined in our <Link className="border-b-2" to={'/legal/privacy_policy'}>Privacy Policy</Link>, we only disclose account information when legally required, such as through a valid subpoena or warrant.</p>
            <h6 className="mb-2 text-lg font-bold">Additional Resources and Support</h6>
            <p className="mb-2">Our <Link className="border-b-2" to={'/legal/safety_tips'}>Safety Tips</Link> offer a range of hotlines and support services for survivors of sexual assault, domestic violence, and other crimes.</p>
            <p className="mb-2">For Colorado-specific resources, please explore:</p>
            <ul className="mb-2">
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">You Have the Right CO </span>Support and information for survivors of sexual assault and their families. <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'https://youhavetherightco.org/'}>https://youhavetherightco.org/</Link></li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">Violence Free Colorado: </span>Services and resources for survivors of domestic violence. <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'https://violencefreecolorado.org/'}>https://violencefreecolorado.org/</Link> </li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">Crime Victim Services Directory: </span>A directory of statewide services for crime victims and advocates. <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'https://ovc.ojp.gov/directory-crime-victim-services'}>https://ovc.ojp.gov/directory-crime-victim-services</Link> </li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">1-844-493-TALK (8255): </span>A 24/7 hotline for those experiencing mental health, substance use, or emotional crises. <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'https://coloradocrisisservices.org/'}>https://coloradocrisisservices.org/</Link> </li>
            </ul>
        </main>
