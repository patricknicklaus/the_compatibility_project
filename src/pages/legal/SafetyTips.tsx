    ...
    <div className="min-h-screen flex flex-col bg-offWhite text-black">
        <main className="flex-grow mt-20 py-10 px-20">
            ...
            <ul className="mb-2">
                ...
                <li className="mb-2 list-disc ml-10 pl-5">You may also report any suspicious activity by emailing us at reports@blinddateworld.com. For more information, check out our <Link className="border-b-2" to={'/legal/community_guidelines'}>Community Guidelines</Link>.</li>
            ...
            <ul className="mb-2">
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">RAINN’s National Sexual Assault Hotline </span>1-800-656-HOPE (4673) | online.rainn.org | <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'http://www.rainn.org'}>www.rainn.org</Link> </li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">National Domestic Violence Hotline </span>1-800-799-SAFE (7233) or 1-800-787-3224 | <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'http://www.thehotline.org'}>www.thehotline.org</Link> </li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">National Human Trafficking Hotline </span>1-888-373-7888 or text 233733 | <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'http://www.humantraffickinghotline.org'}>www.humantraffickinghotline.org</Link> </li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">National Sexual Violence Resource Center </span>1-877-739-3895 | <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'http://www.nsvrc.org'}>www.nsvrc.org</Link> </li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">Cyber Civil Rights Initiative </span>1-844-878-2274 | <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'http://www.cybercivilrights.org'}>www.cybercivilrights.org</Link> </li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">VictimConnect - Crime Victim Resource Center </span>1-855-4VICTIM (855-484-2846) | <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'http://www.victimconnect.org'}>www.victimconnect.org</Link> </li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">FBI Internet Crime Complaint Center </span><Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'http://www.ic3.gov'}>www.ic3.gov</Link> </li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">LGBT National Help Center </span>1-888-843-4564 | <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'http://www.lgbthotline.org'}>www.lgbthotline.org</Link> </li>
                <li className="mb-2 list-disc ml-10 pl-5"><span className="font-bold">Trans Lifeline </span>1-877-565-8860 (US) or 1-877-330-6366 (CA) | <Link className="font-bold border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'http://www.translifeline.org'}>www.translifeline.org</Link> </li>
            </ul>
        </main>
