  ...
  return (
    <div className="min-h-screen flex flex-col bg-offWhite text-black">
        <main className="flex-grow mt-20 py-10 px-20">
            ...
            <p className="mb-2">Please see our <Link className="border-b-2 text-blue-600" to={'/legal/privacy_policy'}>California Privacy Statement</Link> to learn about California privacy rights.</p>
            ...
            <ul className="mb-2">
                ...
                <li className="list-disc ml-10 pl-5">We use Stripe for payment, analytics, and other business services. Stripe collects identifying information about the devices that connect to its services. Stripe uses this information to operate and improve the services it provides to us, including for fraud detection. You can learn more about Stripe and read its privacy policy at <Link className="text-blue-600 border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'https://stripe.com/privacy'}>https://stripe.com/privacy</Link>.</li>
            </ul>
            ...
            <ul className="mb-2">
                <li className="list-disc ml-10 pl-5"><span className="font-bold">Access / Update tools in the service.</span> Tools and account settings that enable you to view, correct, or remove information supplied to us and linked with your account directly inside the service. If you have any queries about those tools or settings, please get in touch with our customer service staff at <Link className="text-blue-600 border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'mailto:help@blinddate.world'}>help@blinddate.world</Link> for assistance.</li>
            ...
            <ul className="mb-2">
                <li className="list-disc ml-10 pl-5"><span className="font-bold">Reviewing your information.</span> You may have the right to inspect the personal information we maintain about you under applicable privacy laws (depending on the jurisdiction, this may be called right of access, right of portability or variations of those terms). You may request a copy or file of your personal information by contacting  <Link className="text-blue-600 border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'mailto:help@blinddate.world'}>help@blinddate.world</Link>.</li>
                <li className="list-disc ml-10 pl-5"><span className="font-bold"></span>Updating your information. If you feel that the information we have on file for you is wrong or you revoke our right to use your details and you wish to seek rectification, deletion, or object to its processing, you may contact us via <Link className="text-blue-600 border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'mailto:help@blinddate.world'}>help@blinddate.world</Link>.</li>
            ...
            <p className="mb-2">We may suspend your use of all or part of the services without notice if we suspect or detect any breach of security. If you believe that your account or information is no longer secure, please notify us immediately at <Link className="text-blue-600 border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'mailto:help@blinddate.world'}>help@blinddate.world</Link>.</p>
            ...
            <p className="mb-2">If you may have other questions about this Privacy Policy, you may email us at <Link className="text-blue-600 border-b-2" to='javascript:void(0)' onClick={() => window.location.href = 'mailto:help@blinddate.world'}>help@blinddate.world</Link>.</p>
